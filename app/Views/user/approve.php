...
<div class="col-md-12" style="margin-bottom:10px">
    <label class="title_name" style="color: #00B14F;">USER APPROVEMENT</label><br>
</div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <br>
                <p class="no-margin">Tekan tombol <b>Approve</b> untuk menyetujui penambahan/perubahan data User Role Baru atau tekan tombol <b>Reject</b> untuk menolak penambahan/perubahan data User Role</p>
                <br>
            </div>
...
<script type="text/javascript">
    ...
    function detail(id_temp) {
        var link = '<?= site_url('user/approved') ?>';
    ...
    $(document).ready(function() {
        var oTable = $('#tabel').dataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?= site_url("user/get_data_temp"); ?>'
            },
